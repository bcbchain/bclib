...
func (app *PersistentKVStoreApplication) GetGenesis() types.ResponseGetGenesis {
	return types.ResponseGetGenesis{}
}

func (app *PersistentKVStoreApplication) Rollback() types.ResponseRollback {
	return types.ResponseRollback{}
}
