...
func (m *Request) GetGenesis() *RequestGetGenesis {
	if x, ok := m.GetValue().(*Request_GetGenesis); ok {
		return x.GetGenesis
	}
	return nil
}
...
func (m *Request) GetRollback() *RequestRollback {
	if x, ok := m.GetValue().(*Request_Rollback); ok {
		return x.Rollback
	}
	return nil
}
...
func _Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Request_GetGenesis:
		_ = b.EncodeVarint(15<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.GetGenesis); err != nil {
			return err
		}
...
func _Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 13: // value.CleanData
		...
		return true, err
	case 15: // value.GetGenesis
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RequestGetGenesis)
		err := b.DecodeMessage(msg)
		m.Value = &Request_GetGenesis{msg}
		return true, err
	case 16: // value.Rollback
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(RequestRollback)
		err := b.DecodeMessage(msg)
		m.Value = &Request_Rollback{msg}
		return true, err
	default:
		return false, nil
	}
...
type RequestCheckTxs struct {
	Txs [][]byte `protobuf:"bytes,1,opt,name=txs,proto3" json:"txs,omitempty"`
}

func (m *RequestCheckTxs) Reset()                    { *m = RequestCheckTxs{} }
func (m *RequestCheckTxs) String() string            { return proto.CompactTextString(m) }
func (*RequestCheckTxs) ProtoMessage()               {}
func (*RequestCheckTxs) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{8} }

func (m *RequestCheckTxs) GetTx() [][]byte {
	if m != nil {
		return m.Txs
	}
	return nil
...
func (m *RequestDeliverTxs) Reset()                    { *m = RequestDeliverTxs{} }
func (m *RequestDeliverTxs) String() string            { return proto.CompactTextString(m) }
func (*RequestDeliverTxs) ProtoMessage()               {}
func (*RequestDeliverTxs) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{9} }

func (m *RequestDeliverTxs) GetTxs() [][]byte {
	if m != nil {
		return m.Txs
	}
	return nil
...
func (m *RequestGetGenesis) Reset()                    { *m = RequestGetGenesis{} }
func (m *RequestGetGenesis) String() string            { return proto.CompactTextString(m) }
func (*RequestGetGenesis) ProtoMessage()               {}
func (*RequestGetGenesis) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{11} }
...
func (*RequestRollback) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{11} }
...
func (*Response_GetGenesis) isResponse_Value() {}
func (*Response_Rollback) isResponse_Value()   {}
...
func (m *Response) GetGenesis() *ResponseGetGenesis {
	if x, ok := m.GetValue().(*Response_GetGenesis); ok {
		return x.Genesis
	}
	return nil
}
...
func (m *Response) Rollback() *ResponseRollback {
	if x, ok := m.GetValue().(*Response_Rollback); ok {
		return x.Rollback
	}
	return nil
}
...
func (*Response) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Response_OneofMarshaler, _Response_OneofUnmarshaler, _Response_OneofSizer, []interface{}{
		...
		(*Response_GetGenesis)(nil),
		(*Response_Rollback)(nil),
	}
}
...
func _Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Response_GetGenesis:
		_ = b.EncodeVarint(15<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Genesis); err != nil {
			return err
		}
	case *Response_Rollback:
		_ = b.EncodeVarint(16<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Rollback); err != nil {
			return err
		}
...
func _Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 15: // value.GetGenesis
		...
		msg := new(ResponseGetGenesis)
		err := b.DecodeMessage(msg)
		m.Value = &Response_GetGenesis{msg}
		return true, err
	case 16: // value.Rollback
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ResponseRollback)
		err := b.DecodeMessage(msg)
...
type ResponseCheckTxs struct {
	ResponseCheckTxs []ResponseCheckTx `protobuf:"responseCheckTxs,1,opt,name=responseCheckTxs,proto3" json:"responseCheckTxs,omitempty"`
}

func (m *ResponseCheckTxs) Reset()                    { *m = ResponseCheckTxs{} }
func (m *ResponseCheckTxs) String() string            { return proto.CompactTextString(m) }
func (*ResponseCheckTxs) ProtoMessage()               {}
...
func (m *ResponseGetGenesis) Reset()                    { *m = ResponseGetGenesis{} }
func (m *ResponseGetGenesis) String() string            { return proto.CompactTextString(m) }
func (*ResponseGetGenesis) ProtoMessage()               {}
func (*ResponseGetGenesis) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{36} }
...
func (*ResponseRollback) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{36} }
...
func init() {
	...
	proto.RegisterType((*RequestCheckTxs)(nil), "types.RequestCheckTxs")
	proto.RegisterType((*RequestCheckTx)(nil), "types.RequestCheckTx")
	proto.RegisterType((*RequestDeliverTxs)(nil), "types.RequestDeliverTxs")
	...
	proto.RegisterType((*RequestGetGenesis)(nil), "types.RequestGetGenesis")
	proto.RegisterType((*RequestRollback)(nil), "types.RequestRollback")
...
func (c *aBCIApplicationClient) GetGenesis(ctx context.Context, in *RequestGetGenesis, opts ...grpc.CallOption) (*ResponseGetGenesis, error) {
	out := new(ResponseGetGenesis)
	err := grpc.Invoke(ctx, "/types.ABCIApplication/GetGenesis", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIApplicationClient) Rollback(ctx context.Context, in *RequestRollback, opts ...grpc.CallOption) (*ResponseRollback, error) {
	out := new(ResponseRollback)
	err := grpc.Invoke(ctx, "/types.ABCIApplication/Rollback", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIApplicationServer interface {
	...
	GetGenesis(context.Context, *RequestGetGenesis) (*ResponseGetGenesis, error)
	Rollback(context.Context, *RequestRollback) (*ResponseRollback, error)
}
...
func _ABCIApplication_GetGenesis_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestGetGenesis)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).GetGenesis(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.ABCIApplication/GetGenesis",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).GetGenesis(ctx, req.(*RequestGetGenesis))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCIApplication_Rollback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestRollback)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIApplicationServer).Rollback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.ABCIApplication/Rollback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIApplicationServer).Rollback(ctx, req.(*RequestRollback))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCIApplication_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ABCIApplication_GetGenesis_Handler,
		},
		{
			MethodName: "Rollback",
			Handler:    _ABCIApplication_Rollback_Handler,
		},
	},
