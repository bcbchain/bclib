...
func (cli *socketClient) GetGenesisAsync() *ReqRes {
	return cli.queueRequest(types.ToRequestGetGenesis())
}

func (cli *socketClient) RollbackAsync() *ReqRes {
	return cli.queueRequest(types.ToRequestRollback())
}
...
func (cli *socketClient) GetGenesisSync() (*types.ResponseGetGenesis, error) {
	reqres := cli.queueRequest(types.ToRequestGetGenesis())
	cli.FlushSync()
	return reqres.Response.GetGenesis(), cli.Error()
}

func (cli *socketClient) RollbackSync() (*types.ResponseRollback, error) {
	reqres := cli.queueRequest(types.ToRequestRollback())
	cli.FlushSync()
...
func resMatchesReq(req *types.Request, res *types.Response) (ok bool) {
	...
	case *types.Request_GetGenesis:
		_, ok = res.Value.(*types.Response_GetGenesis)
	case *types.Request_Rollback:
		_, ok = res.Value.(*types.Response_Rollback)
	}
	return ok
}
