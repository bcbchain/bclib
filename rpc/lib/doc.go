...
* [Tendermint](https://github.com/bcbchain/tendermint/tendermint/blob/master/rpc/core/routes.go)
* [tm-monitor](https://github.com/bcbchain/tendermint/tools/blob/master/tm-monitor/rpc.go)
*/
package rpc
